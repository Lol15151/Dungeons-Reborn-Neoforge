package net.lol15.dungeonsreborn.mod.worldgen.biome;

import net.lol15.dungeonsreborn.mod.DungeonsReborn;
import net.lol15.dungeonsreborn.mod.worldgen.biome.region.NetherRegion;
import net.lol15.dungeonsreborn.mod.worldgen.biome.region.OverworldRegion;
...
public class ModBiomes {
    ...
    public static void registerBiomes() {
        Regions.register(new OverworldRegion(ResourceLocation.fromNamespaceAndPath(DungeonsReborn.MODID, "mccourse_overworld"), 20));
        Regions.register(new NetherRegion(ResourceLocation.fromNamespaceAndPath(DungeonsReborn.MODID, "mccourse_nether"), 20));
    ...
    private static ResourceKey<Biome> registerBiomeKey(String name) {
        return ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(DungeonsReborn.MODID, name));
    }
}