...
public class ArmorStatueBlockEntityRenderer
        extends GeoBlockRenderer<ArmorStatueBlockEntity> {
    ...
    public ArmorStatueBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        super(new ArmorStatueGeoModel());
        this.rotX = 0f;
        this.rotZ = 135f;
        this.offsetX = 0f;
        this.offsetY = 0.3f;
    ...
    @Override
    public void render(ArmorStatueBlockEntity blockEntity,
                       float partialTick,
                       PoseStack poseStack,
        ...
        float yRotation = 0f;
        if (blockEntity.getBlockState().hasProperty(ArmorStatueBlock.FACING)) {
            Direction facing = blockEntity.getBlockState().getValue(ArmorStatueBlock.FACING);
            switch (facing) {
